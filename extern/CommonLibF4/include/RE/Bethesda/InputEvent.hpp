...
namespace RE
{
	...
	public:
		...
		REX::Enum<INPUT_EVENT_TYPE, std::uint32_t> eventType{ INPUT_EVENT_TYPE::kNone }; // 10
		InputEvent* next{ nullptr };													 // 18
		std::uint32_t timeCode{ static_cast<std::uint32_t>(-1) };						 // 20
		REX::Enum<HANDLED_RESULT, std::uint32_t> handled{ HANDLED_RESULT::kUnhandled };	 // 24
	};
	...
	public:
		...
		inline static constexpr auto TYPE{ INPUT_EVENT_TYPE::kChar };
	...
	public:
		...
		inline static constexpr auto TYPE{ INPUT_EVENT_TYPE::kDeviceConnect };
	...
	public:
		...
		inline static constexpr auto TYPE{ INPUT_EVENT_TYPE::kButton };
	...
	public:
		...
		inline static constexpr auto TYPE{ INPUT_EVENT_TYPE::kCursorMove };
	...
	public:
		...
		inline static constexpr auto TYPE{ INPUT_EVENT_TYPE::kKinect };
	...
	public:
		...
		inline static constexpr auto TYPE{ INPUT_EVENT_TYPE::kMouseMove };
	...
	public:
		...
		inline static constexpr auto TYPE{ INPUT_EVENT_TYPE::kThumbstick };
